...
bg_menu = main_dir + conf.background_menu
bg = main_dir + conf.background
b_img = main_dir + conf.ball_image
rect_img = main_dir + conf.rect_image

font_col = conf.font_color
f_set_col = conf.font_select_color

font = main_dir + conf.font
music = main_dir + conf.cool_music
sound = main_dir + conf.cool_sound
nsound = main_dir + conf.not_cool_sound
################################
